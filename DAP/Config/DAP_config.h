...
#define CPU_CLOCK               60000000U       ///< CH592 system clock.
...
/// required.
#define IO_PORT_WRITE_CYCLES    4U              ///< CH592 MMIO load/modify/store cost.
...
#define DAP_PACKET_SIZE         64U             ///< Full-speed USB bulk packet size.

/// Maximum Package Buffers for Command and Response data.
/// This configuration settings is used to optimize the communication performance with the
/// debugger and depends on the USB peripheral. For devices with limited RAM or USB buffer the
/// setting can be reduced (valid range is 1 .. 255).
#define DAP_PACKET_COUNT        8U              ///< Buffered WinUSB requests/responses.

/// Indicate that UART Serial Wire Output (SWO) trace is available.
/// This information is returned by the command \ref DAP_Info as part of <b>Capabilities</b>.
#define SWO_UART                0               ///< SWO is not implemented in this build.
...
#define SWO_BUFFER_SIZE         256U            ///< Disabled; retained for CMSIS-DAP headers.

/// SWO Streaming Trace.
#define SWO_STREAM              0               ///< SWO Streaming Trace: 1 = available, 0 = not available.

/// Clock frequency of the Test Domain Timer. Timer value is returned with \ref TIMESTAMP_GET.
#define TIMESTAMP_CLOCK         0U              ///< Timestamp is not implemented.

/// Indicate that UART Communication Port is available.
/// This information is returned by the command \ref DAP_Info as part of <b>Capabilities</b>.
#define DAP_UART                0               ///< UARTs are exposed as two USB CDC interfaces.
...
__STATIC_INLINE uint8_t DAP_GetSerNumString (char *str) {
  extern char ch592_dap_serial[17];
  uint8_t i;
  for (i = 0U; i < 17U; i++) {
    str[i] = ch592_dap_serial[i];
  }
  return (17U);
}
